...
## 🙋‍♀️ 關於我
Hi，我是陳怡珊，就讀輔仁大學資訊管理學系，GPA 4.0，系上排名前 9%。我對 AI、人機互動、虛擬系統充滿熱情，也熱愛插畫與設計，追求技術與創意的結合，打造兼具功能與美感的數位體驗。我對人與科技互動方式充滿熱忱，目前專注於資訊系統與多媒體互動設計。修讀資訊管理主修與資訊工程輔系，並以高 GPA 表現出色。曾獲得書卷獎與競賽決賽晉級，開發過基於 SOAP 架構的互動系統與三層式 CURD 系統，畢業專題則是開發醫療影像辨識系統開發與教學系統專案。

在大學期間主導 GalaBone 骨骼健康教育系統專題，擔任組長與系統整合工程師，負責從 S0 需求規劃到 S1 YOLOv8‑OBB 醫學影像偵測、S2 RAG AI Agent、S3 3D/MR 與 BoneDB 的跨模組整合與 Debug。 專題完成影像上傳、偵測、知識檢索與 3D/MR 顯示的完整流程，在 2006 張 X 光影像上達到 mAP@0.5 約 0.916，並通過多個 User Story 情境測試。
