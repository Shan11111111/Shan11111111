...
**主要技術**  
PHP、MySQL、JavaScript、Bootstrap、AJAX、Session 管理

**我的工作內容與貢獻**  
- 後台系所與管理者的資料傳值邏輯設計與實作  
- 系統基本資料庫設計與建置（ERD設計、SQL撰寫）  
- 後端核心功能開發：  
  - 登入、登出、註冊完整流程  
  - 建言提交、附議、留言（建言及募資留言區）功能  
  - 處所分類達標建言處理及移轉提案流程  
  - 募資提案提出、審核與退回流程  
  - 系統管理者與系所管理者的人員與提案管理  
  - 捐贈表單後端處理  
  - 延期募資截止日期申請與審核  
- 前端動態網頁轉場效果製作（換場進度條、轉圈動畫等）  
- 文件撰寫（系統發展背景與動機、目的、競品分析、資料庫設計等）
...
<a href="https://github.com/Shan11111111/system_project">查看GitHub</a>
</ul>
