...
我在大學期間主導 GalaBone 骨骼健康教育系統專題，擔任組長整合組員意見與提供系統相關的開發實作建議與系統整合，除了負責規劃系統需求、企劃書撰寫、資料庫設計與建置、專案架構整合，我也參與整合 S1 YOLOv8‑OBB 醫學影像偵測、S2 RAG、S3 3D/MR 與 BoneDB資料庫的跨模組整合與 Debug。程式主要負責是使用者登入、登出、註冊、驗證帳號、權限等邏輯設計、RAG語意檢索優化、docker Qdrant向量資料庫檢索設計、向量資料庫中之上傳檢索教材資料之控管與chunk實驗，此外，我也負責製作學習教材的模板、辨識模型前處理胸廓部位的標記工作、上下文短期對話優化、RAG回應時間優化、IRB審查企劃書撰寫與準備。最後畢業專題完成以React框架作為前端，FastAPI框架作為後端，SQL server與Qdrant作為資料庫，並以IIS部署學習有關網頁部署的防火牆設定之實作，畢業專題整合並應用YOLO影像上傳偵測、RAG知識檢索與 3D 模型互動顯示之完整流程來輔助初學者學習骨骼知識。 大三上時，以此專題為基礎撰寫研討會論文，投稿並獲 IMP 2025 研討會接受與發表，內容涵蓋系統架構設計與實驗結果，讓我初步累積將實作成果轉化為學術論文的經驗，也更加確立未來希望在研究所持續深耕 AI 與 3D/MR 互動系統相關研究的目標。
...
### 🎯 程式技能與開發經驗
- **程式語言**：Python（Flask, Selenium, OpenCV, FastAPI）、C、C#、PHP、
- **前端**：HTML5、CSS、JavaScript、Three.js、Bootstrap 5、React.js
- **資料庫**：MySQL、SQL server、PostgreSQL
- **自動化測試腳本撰寫**：Selenium
