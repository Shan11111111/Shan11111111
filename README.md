...
我在大學期間主導 GalaBone 骨骼健康教育系統專題，擔任組長整合組員意見與提供系統相關的開發實作建議與系統整合，除了負責規劃系統需求、企劃書撰寫、資料庫設計與建置、專案架構整合，我也參與整合 S1 YOLOv8‑OBB 醫學影像偵測、S2 RAG、S3 3D/MR 與 BoneDB 的跨模組整合與 Debug。程式主要負責是使用者登入登出註冊邏輯設計、RAG語意檢索優化與Qdrant向量資料庫邏輯設計、系統可自動化下載之PowerPoint教材模板製作與編排、辨識模型前處理標記工作。專題完成影像上傳、偵測、知識檢索與 3D/MR 顯示的完整流程。 大三時，以此專題為基礎撰寫論文，投稿並獲 IMP 2025 研討會接受與發表，內容涵蓋系統架構設計與實驗結果，讓我初步累積將實作成果轉化為學術論文的經驗，也更加確立未來希望在研究所持續深耕 AI 與 3D/MR 互動系統相關研究的目標。
